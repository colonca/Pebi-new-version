 <div class="sidebar bg-gray-50 w-68 flex-none flex flex-col overflow-y-hiden" style="width: 22%">
 	...
 	<div class="pt-12  flex flex-col items-start flex-grow overflow-y-auto">
 		...
 		<x-sidebar.dropdown title="Generales" :active="false">
 			<x-slot name="icon">
 				<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
 		...
 		<x-sidebar.dropdown title="Academico" :active="request()->is('academico*')">
 			...
 			<x-slot name="items">
 				...
 				@endcan
                @can('periodos.index')
                  <x-sidebar.link title="Periodos" :link="url('/academico/periodos')" :active="request()->is('academico/periodos')">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <x-sidebar.dropdown title="Reportes" :active="request()->is('reportes*')">
            ...
            <x-slot name="items">
                @can('reportes.lineas')
                    <x-sidebar.link title="Lineas" :link="url('/reportes/lineas')" :active="request()->is('reportes/lineas*')">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
                        </svg>
                    </x-sidebar.link>
                @endcan
                @can('reportes.riesgos')
                 <x-sidebar.link title="Tipos de Riesgo" :link="url('/reportes/riesgos')" :active="request()->is('reportes/riesgos*')">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
 		...
 		<x-sidebar.dropdown title="Cargas Masivas" :active="false">
 			<x-slot name="icon">
 				<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
 					<path d="M12 14l9-5-9-5-9 5 9 5z" />
 					<path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
 			...
 			<x-slot name="items">
 				@can('estudiantes.index')
 				<x-sidebar.link title="Estudiantes" :link="url('/cargas/estudiantes')" :active="request()->is('cargas/estudiantes*')">
 					<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
 						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
 					</svg>
 				</x-sidebar.link>
        ...
        <x-sidebar.dropdown title="Usuarios" :active="true">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M12 14l9-5-9-5-9 5 9 5z" />
                    <path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
            ...
            <x-slot name="items">
                @can('usuarios.index')
                    <x-sidebar.link title="Usuarios" :link="url('usuarios/users')" :active="request()->is('users*')">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                    </x-sidebar.link>
