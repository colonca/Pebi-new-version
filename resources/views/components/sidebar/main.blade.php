 <div class="sidebar bg-gray-50 w-68 flex-none flex flex-col  overflow-y-hiden">
     ...
     <div class="pt-12  flex flex-col items-start flex-grow overflow-y-auto">
        ...
        <x-sidebar.dropdown title="Generales" :active="request()->is('generales*')" >
            <x-slot name="icon" >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <x-sidebar.dropdown title="Intervenciones" :active="request()->is('intervenciones*')" >
            ...
            <x-slot name="items" >
                <x-sidebar.link title="Grupales" :link="url('/intervenciones/grupales*')" :active="request()->is('intervenciones/grupales*')">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
