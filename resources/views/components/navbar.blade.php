<div class="navbar flex items-center">
	...
	<ul class="navbar__menu flex item-center  text-gray-500">
		...
		<li class="navbar__menu__date flex items-center bg-green-200 p-2 rounded-md cursor-pointer">
			<span>
				<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
				</svg>
			</span>
			<span class="text-sm font-semibold ml-2">Sync Academosoft</span>
		</li>

		<li class="navbar__menu__date flex items-center bg-blue-100 p-2 rounded-md ml-4">
			<span class="mr-2">
