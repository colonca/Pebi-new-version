...
<div x-data="{{json_encode(['show' => true, 'style' => $style, 'message' => $message])}}">
    <div x-show="show && message" style="display: none" x-init="
        ...
        <div class="my-2 mx-auto">
            <div class="flex items-center justify-between flex-wrap bg-gray-100 py-2 px-4 rounded shadow border-b-2" :class="{ 'border-green-400': style == 'success', 'boder-red-400' : style === 'danger' }">
                ...
                <div class="flex-shrink-0 sm:ml-3">
                    <button type="button" class="-mr-1 flex p-2 rounded-full focus:outline-none sm:-mr-2 transition" aria-label="Dismiss" x-on:click="show = false">
