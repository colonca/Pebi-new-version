<div>
	...
	<x-table.table :header="['Identificacion','Estudiante','Motivo','Estado','Tallerista','Fecha de Remision', 'Creada','Acciones']">
		...
		<tr class="text-gray-500">
			...
			<x-table.td>{{date('M j, Y',strtotime($remision->created_at))}}</x-table-td>
			<td class="text-left">
			   <button class="cursor-pointer" wire:click="cambiar_estado({{$remision->id}})">
