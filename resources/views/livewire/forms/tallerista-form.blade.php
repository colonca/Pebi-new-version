        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="flex items-center mt-2">
                <div class="flex flex-grow">
                    ...
                    <div class="mr-2 w-1/2">
                        <x-jet-label class="font-bold">Correo Personal</x-jet-label>
                        <x-jet-input id="correo_personal" class="block mt-1 w-full" type="text" wire:model="form.correo_personal" placeholder="Correo Personal" />
                    </div>
                </div>
                <div class="">
