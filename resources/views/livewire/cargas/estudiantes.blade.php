<div>
	<form class="h-96 flex items-center justify-center" wire:submit.prevent="upload">
		<div class="upload">
			...
			<button type="button" class="upload-document flex justify-center items-center flex-col cursor-pointer" onclick="document.getElementById('import').click();">
				...
				<span class="font-semibold text-sm text-gray-500">{{$file !== '' ? $file : 'Subir Archivo'}}</span>
			</button>
